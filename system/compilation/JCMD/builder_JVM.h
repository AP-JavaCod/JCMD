...
extern "C" {
	...
	JNIEXPORT jstring JNICALL Java_build_Builder_compilation(JNIEnv*, jobject, jlong, jstring, jdouble);

	JNIEXPORT jstring JNICALL Java_build_Builder_build(JNIEnv*, jobject, jlong, jstring, jstring, jdouble);
